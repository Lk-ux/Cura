...
data = {
    ...
    "Gender": "M",
    "Height_cm": 175.0,
    "Weight_kg": 635.0,  # extreme but recorded
    "Waist_cm": 300.0,
    "Systolic_BP": 300,
    "Diastolic_BP": 200,
    "Resting_Heart_Rate": 220,
    "HDL_mg_dl": 5.0,
    "LDL_mg_dl": 500.0,
    "Triglycerides_mg_dl": 10000.0,
    "Fasting_Glucose_mg_dl": 2000.0,
    "HbA1c_percent": 25.0,
    "Sleep_hours": 23.0,
    ...
    ] * 7,  # same record repeated for 7 days
    "Occupation_type": "Unemployed",
    "Diet_type": "Highly processed, ultra-high fat/sugar",
    "Caffeine_cups_per_day": 20,
    "Sunlight_exposure_min_per_day": 0,
    "Sleep_consistency": 0,
    "Perceived_health_score": 0
}

print(predict_cvd_risk(data))